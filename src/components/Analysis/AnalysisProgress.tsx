    ...
    <div className="cloud-tile !py-12 no-anim-cloud flex flex-col items-center justify-center gap-10 relative overflow-hidden min-h-[400px]">
      ...
      <div className="text-center space-y-6 z-10">
        <div className="space-y-2">
          ...
          <p className="text-cloud/40 text-sm font-mono uppercase tracking-widest">AI Core V4.2 Active</p>
        </div>

        {/* Status Logs */}
        <div className="glass-card bg-black/40 p-4 w-64 mx-auto text-left font-mono text-[10px] space-y-1 overflow-hidden h-24">
          <StatusLog delay={0} text="> INITIALIZING AI CORE..." />
          <StatusLog delay={1000} text="> EXTRACTING AI ARTIFACTS..." />
          <StatusLog delay={2000} text="> ANALYZING SYNTHETIC PATTERNS..." />
          <StatusLog delay={3000} text="> CALCULATING AI AUTHENTICITY..." />
          <StatusLog delay={4000} text="> FINALIZING AI FORENSIC REPORT..." />
        </div>
      </div>
    </div>
  );
