...
export function SpecsView({ onNavigate }: SpecsViewProps) {
  return (
    ...
    >
      ...
      <h2 className="text-5xl font-bold mb-8">Specifications</h2>
      
      <div className="space-y-12">
        <section className="space-y-4">
          <h3 className="text-2xl font-bold">Forensica AI</h3>
        ...
        <section className="space-y-6 pt-8 border-t border-white/10">
          <h3 className="text-2xl font-bold">Why Forensica AI</h3>
        ...
        <div className="pt-12 text-center">
          <p className="text-3xl font-bold italic opacity-50 mb-8">Truth, Verified.</p>
          <button onClick={() => onNavigate('selection')} className="btn-cloud">Get Started Now</button>
        </div>
      </div>
    </motion.div>
  );
